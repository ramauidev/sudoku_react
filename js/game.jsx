...
function GithubCorner() {
  return (
    <a target="_blank" href="https://github.com/ramauidev/sudoku_react" className="github-corner">
  ...
  render() {
    return (
      <div className="index">
        ...
        <a href="https://github.com/ramauidev/sudoku_react" target="_blank">GitHub</a></p>
      </div>
    );
  }
